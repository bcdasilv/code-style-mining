...
def read_from_file(file_name, output_setting, mdb_name, mdb_password, mdb_cluster, mdb_database):
    ...
    for i in range(len(lines)):
        ...
        try:
            ...
            handle_output(output_setting, results, mdb_name,
                          mdb_password, mdb_cluster, mdb_database)
...
def handle_output(setting, results, mdb_name, mdb_password, mdb_cluster, mdb_database):
    if setting == "c":
        ...
        try:
            write_to_mongodb(mdb_name, mdb_password, mdb_cluster,
                             mdb_database, results[C_REPO_FULL_NAME], results)
...
def main(argv):
    ...
    usage_msg = "Usage: python3 main.py <GitHub_OAuth_token> [-file <file_name>] " \
                "[-mongodb <username> <password> <cluster> <database>]"
    ...
    if input_setting == "c":
        ...
        read_from_file(file_name, output_setting, mdb_name, mdb_password, mdb_cluster, mdb_database)
